...
Download the external tool palette here: [`Download Link`](https://github.com/EvokeMadness/AutoCAD-XTP/releases/latest/download/AutoCAD-2023-tool-palettes.zip)
...
Also check out my AutoCAD hot keys cheat sheet here: [`Repository Link`](https://github.com/EvokeMadness/AutoCAD-hot-keys)
